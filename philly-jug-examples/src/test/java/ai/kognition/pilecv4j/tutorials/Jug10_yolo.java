...
public class Jug10_yolo extends BaseTest {
    ...
    public void test() throws Exception {
        ...
        try(
            ...
            final ParamBlock params = ParamBlock.builder()
                .arg("/data/offline-test-data/od-models/yolo-pytorch/yolov5s/yolov5s.pt")
                .arg(python);

            // start the python system by calling a function
            python.runPythonFunctionAsynch("runyolo", "runyolo", params)
                .waitUntilSourceInitialized(10000);

            // retrieve the model labels from the python side
            final String[] labels = python.retrieveModelLabels();
            ...
            c
                ...
                .processVideoFrames(new AsyncVideoFrameConsumer(f -> {
                    ...
                    try(
                        ...
                        final PythonResults results = python.sendMat(lbDetails.mat(), f.isRgb, null);
